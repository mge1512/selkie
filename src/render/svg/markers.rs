...
pub fn create_arrow_markers(_theme: &Theme) -> Vec<SvgElement> {
    vec![
        ...
        SvgElement::Marker {
            ...
            ref_x: 6.0,  // mermaid.js uses refX: 6
            ref_y: 5.0,
            marker_width: 12.0,  // mermaid.js uses 12
            marker_height: 12.0, // mermaid.js uses 12
        ...
        // Arrow circle (filled circle) - like mermaid.js circle marker
        SvgElement::Marker {
            id: "arrow_circle".to_string(),
            view_box: "0 0 10 10".to_string(),
            ref_x: 11.0,  // mermaid.js uses refX: 11
            ref_y: 5.0,
            marker_width: 11.0,  // mermaid.js uses 11
            marker_height: 11.0, // mermaid.js uses 11
            orient: "auto".to_string(),
        ...
        SvgElement::Marker {
            ...
            view_box: "0 0 10 10".to_string(),
            ref_x: 4.5,  // mermaid.js uses refX: 4.5 for start
            ref_y: 5.0,
            marker_width: 12.0,
            marker_height: 12.0,
            orient: "auto".to_string(),
            marker_units: Some("userSpaceOnUse".to_string()),
            children: vec![SvgElement::path("M 0 5 L 10 10 L 10 0 z")], // mermaid.js path
        },
